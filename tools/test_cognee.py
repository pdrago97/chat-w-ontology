...
from cognee_service import TextDoc, run_cognee

def test_cognee_integration():
    """Test the Cognee integration with sample documents"""
    ...
    if not os.getenv("OPENAI_API_KEY"):
        print("Warning: OPENAI_API_KEY not set. Cognee may not work properly.")
    
    try:
        result = run_cognee(sample_docs)
        ...
        print("\n✅ Cognee integration test completed successfully!")
        return True
